...
?>
    ...
    ?>
        <tr>
            ...
            <td><i class="fas fa-trash-alt tm-trash-icon"></i></a></td>
            <td><a href="P-Edit.php?id=<?php echo $singleProduct['id']?>"><i class="far fa-edit"></i></a></td>
    ...
    ?>
			  ...
			  foreach($allcategories as $singlecategory){
                      ?>
                                <tr>
                                    ...
                                    <td><i class="fas fa-trash-alt tm-trash-icon"></i></a></td>
                                    <td><a href="Edit-category.php?id=<?php echo $singlecategory['id']?>"><i class="far fa-edit"></i></a></td>
              ...
              ?>
                        ...
                        <a href="AddCategories.php" class="btn btn-primary tm-table-mt">Add New Category</a>
                    </div>
                </div>
            </div>
            <?php
